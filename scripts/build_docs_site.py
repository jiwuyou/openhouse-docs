...
TITLE_MAP = {
    ...
    "CAPABILITIES_MAP.md": "能力地图",
    "WORKBENCH_OPTIONS.md": "工作台选项",
    "OPENHOUSE_FIRST_CONFIGURATION.md": "首次配置",
    "AI_TOOL_POSTINSTALL.md": "后置 AI 能力",
    "MODEL_API_SETUP.md": "模型与 API 配置",
    "CLOUDCLI_CLAUDE_CODE.md": "CloudCLI 与 Claude Code",
    "SERVICE_MANAGER.md": "服务控制",
    "OPENHOUSE_SMALL_APP_GUIDE.md": "小 App 开发与统一接入",
    "RECOVERY.md": "恢复与修复",
    "PI_AGENT_PLUGIN_SYSTEM.md": "pi-agent 与插件",
    "OPENHOUSE_DESKTOP.md": "OpenHouse 桌面",
    "AI_AGENT_REFERENCE.md": "AI 参考",
...
DOC_ORDER = [
    ...
    "SERVICE_MANAGER.md",
    "OPENHOUSE_SMALL_APP_GUIDE.md",
    "RECOVERY.md",
    "PI_AGENT_PLUGIN_SYSTEM.md",
    "OPENHOUSE_DESKTOP.md",
